        ...
        <div class="d-flex flex-row">
            <div class="d-flex flex-column bg-light pt-3" style="width : 250px" id="sidebar">
                ...
                <nav class="nav flex-column mt-3">
                    ...
                    <?php if(isset($sess->user->role)){if($sess->user->role == 0){?>
                    <a class="nav-link text-secondary <?= $active === 'petugas' ? 'text-dark' : ''?>" href="<?=base_url()?>petugas"><i class="fa-solid fa-user"></i> Kelola Petugas</a>
                    <?php }}?>
