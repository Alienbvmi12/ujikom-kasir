<div class="d-flex flex-column bg-light pt-3" style="width : 250px" id="sidebar">
    ...
    <nav class="nav flex-column mt-3">
        ...
        <?php } else {
        ?>
            <a class="nav-link text-secondary <?= $active === 'diskon' ? 'text-dark' : '' ?>" href="<?= base_url() ?>petugas/diskon"><i class="fa-solid fa-tag"></i> Diskon</a>
        <?php
        }
        ?>
        ...
        <?php
        if ($this->is_admin()) { ?>
            <a class="nav-link text-secondary <?= $active === 'laporan' ? 'text-dark' : '' ?>" href="<?= base_url() ?>admin/penjualan"><i class="fa-solid fa-file-lines"></i> Laporan Penjualan</a>
        <?php } else {
        ?>
            <a class="nav-link text-secondary <?= $active === 'laporan' ? 'text-dark' : '' ?>" href="<?= base_url() ?>petugas/penjualan"><i class="fa-solid fa-file-lines"></i> Histori Transaksi</a>
        <?php
        }
        ?>
    </nav>
