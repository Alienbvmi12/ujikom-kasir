...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2024 at 06:19 PM
...
INSERT INTO `admin` (`id`, `nama`, `username`, `email`, `password`, `created_at`, `status`) VALUES
(1, 'Rayhan-Chan', 'admin', 'email@example.com', '$2y$10$xVKaOwFif8dOkhkVfnRV1Owhhp/ScYenrPmhmONxL1K9L.W9X6PW.', '2024-04-17 14:32:48', 1);
...
('5545240417000004', '1234567890123400', 'Kajni', '081224018633', 'Jl. Perjalanan tanpa akhir', '2024-04-02', '2024-04-30', 1, 1, '2024-04-16 22:45:05'),
('7563240312000003', '1122334455667789', 'Bika ambon 2', '0829838136', 'unuynjuyjnuy', '2024-03-12', '2024-07-15', 1, 0, NULL),
...
('BRG0002', 'Gayung Super Saderek', 9000.00, 15, 0, NULL),
('BRG0003', 'Ikan Girang', 13000.14, 75, 0, NULL),
...
INSERT INTO `transaksi` (`id`, `tanggal_transaksi`, `user_id`, `admin_id`, `member_id`, `subtotal_harga`, `diskon_id`, `diskon`, `cash`) VALUES
('202404100007', '2024-04-10', 1, NULL, '3281240308000001', 18000.00, NULL, NULL, 35000.00),
('202404100014', '2024-04-10', 1, NULL, NULL, 95000.28, NULL, NULL, 80000.00),
('202404110001', '2024-04-11', 9, NULL, NULL, 18000.00, NULL, NULL, 20000.00),
('202404130001', '2024-04-13', 1, NULL, '7563240312000003', 27000.00, NULL, NULL, 30000.00),
('202404130002', '2024-04-13', 1, NULL, NULL, 60000.00, NULL, NULL, 60000.00),
('202404130003', '2024-04-13', 1, NULL, '4238240301000002', 75000.00, 1, 25, 60000.00),
('202404160001', '2024-04-16', 8, NULL, '7563240312000003', 470000.00, 1, 25, 360000.00),
('202404160002', '2024-04-16', 1, NULL, '7563240312000003', 10200000.00, 6, 99, 102000.00),
('202404170001', '2024-04-17', 1, NULL, '7563240312000003', 45000.00, 1, 25, 35000.00),
('202404170002', '2024-04-17', 9, NULL, '7563240312000003', 115000.00, 1, 25, 87000.00),
('202404170003', '2024-04-17', NULL, 1, NULL, 36000.00, NULL, NULL, 40000.00),
('202404170004', '2024-04-17', 1, NULL, '7563240312000003', 65000.70, 1, 25, 50000.00);
...
(27, '202404170003', 'BRG0002', 9000.00, 4),
(28, '202404170004', 'BRG0003', 13000.14, 5);
...
INSERT INTO `user` (`id`, `nama`, `username`, `email`, `password`, `created_at`, `status`, `is_deleted`, `deleted_at`) VALUES
(1, 'M. Rayhan F', 'administrator', 'rayfathur2006@gmail.com', '$2y$10$SdVi/8EjkGEgiukhf7WvrOa47wfTWL4McQhzHWJgRYo9HxeihEU8m', '2024-03-21 02:16:22', 1, 0, NULL),
(8, 'petugas', '123456', 'petugas@gmail.com', '$2y$10$foKgN2fd8s5EHkvj1jj7wO2.APYYf8IMKjblmz22OMhbmft9PPjOS', '2024-03-23 13:30:52', 1, 1, '2024-04-16 22:36:28'),
(9, 'King Slayer', 'petugas', 'vicepetugas@outlook.com', '$2y$10$4JAVyVKASbnDsQp1EPVZpeQcZPpALBNKKlKPLtQL0Bf.XV8ZpdgRe', '2024-03-23 13:32:11', 1, 0, NULL);
...
ALTER TABLE `transaksi`
  ...
  ADD CONSTRAINT `transaksi_ibfk_7` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`id`);
